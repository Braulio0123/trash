...
const VAPID_PUBLIC_KEY = 'BAcyuZb3w9SFVUJc5wuVmYGppRibHkHssTD2Sx53gKaVOoX-IC75iv_-CZM2HXUSCM6nMg6Qos2_-Z2K47BTLws';
...
export function login(event) {
  ...
  fetch('https://trash-server-8bca.onrender.com/api/users/login', {
    method: 'POST',
    headers: {
